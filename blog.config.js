...
const BLOG = {
  AUTHOR: 'xubaoyu', // 作者
  BIO: '那是一只松鼠吗', // 作者简介
  LINK: 'https://test.com', // 网站地址
  KEYWORDS: '博客，笔记', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '7e3b1dcfb7aa4504b72eaf2a0b1b9097', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'xubaoyu12@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
